...
namespace Microform.Functions.Migrations
{
    ...
    [Migration("20211024011245_FirstMigration2")]
            ...
            modelBuilder.Entity("Microform.Functions.Data.Entities.ApplicationRequestEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedUtcTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 24, 1, 12, 44, 681, DateTimeKind.Utc).AddTicks(2100));
            ...
            modelBuilder.Entity("Microform.Functions.Data.Entities.ApplicationRequestResultEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedUtcTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 24, 1, 12, 44, 689, DateTimeKind.Utc).AddTicks(5370));
